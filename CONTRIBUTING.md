...
# **Contributing to Chatty Rusty**

Thank you for considering contributing to **Chatty Rusty**! 🎉 Your help is valuable in improving this project. Below are the guidelines to help you get started.
...
- **Suggest a new feature**: Propose ideas for new functionality. 
- **Bug Fixes**: Identify and fix issues.
- **Documentation**: Improve existing documentation or add missing details.

Check out [GitHub Issues](https://github.com/paaggeli/chatty_rusty/issues) for beginner-friendly tasks or feature requests!
...
Before starting any work, check the [Issues](https://github.com/paaggeli/chatty_rusty/issues) tab to see if your contribution idea has already been reported or suggested.
...
### 3. **Clone Your Fork**
```bash
   git clone https://github.com/your-username/chatty_rusty.git
   cd chatty_rusty  
```
